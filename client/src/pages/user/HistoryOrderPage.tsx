                ...
                <div className="flex overflow-x-auto [&::-webkit-scrollbar]:hidden gap-3 mb-8 pb-2">
                    {tabs.map(tab => (
                        <button 
                            ...
                            className={`px-5 py-2.5 rounded-full text-xs md:text-sm font-bold whitespace-nowrap transition-all border ${
                                activeTab === tab 
                ...
                <div className="flex flex-col w-full">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 opacity-50">
                            ...
                            <p className="text-sm md:text-base font-semibold">No transactions found</p>
                        </div>
                    )}
                </div>
